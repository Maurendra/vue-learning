        ...
        <div className="mb-4">
          <div className="mb-4">
            <div className="w-full bg-neutral-50 py-4 px-8 border-2 border-neutral-300 items-center rounded-lg flex space-x-4">
              <input type="text" className="text-neutral-500 placeholder-gray-300 text-base leading-6 flex-1 bg-neutral-50 border-none focus:outline-none" placeholder="Username" v-model="username" />
            </div>
          </div>
          <div>
            <div className="w-full bg-neutral-50 py-4 px-8 border-2 border-neutral-300 items-center rounded-lg flex space-x-4">
              <input type="password" className="text-neutral-500 placeholder-gray-300 text-base leading-6 flex-1 bg-neutral-50 border-none focus:outline-none" placeholder="Password" v-model="password" />
            </div>
          </div>
        </div>
        <button type="submit" className="flex items-center w-full justify-center">
